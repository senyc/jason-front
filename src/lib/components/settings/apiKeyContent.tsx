    ...
    <div className='flex flex-col pr-3'>
      ...
      <div className='flex flex-row justify-between border-b-[.5px] border-gray-200 pb-2'>
        <button
          ...
          className='mb-[2px] min-w-10 rounded-lg border-[.5px] border-gray-200 p-2 text-center text-sm font-normal transition duration-75 ease-in hover:bg-gray-100 dark:hover:bg-gray-700'
        >
          Generate new key
        </button>
        <button
