...
export default function DeleteAccount({ cancelAction, emailAddress }: DeleteAccountProps) {
    ...
    <div>
      ...
      >
        <div className="mb-3 mt-3 flex flex-col">
          ...
          >
            Please confirm this action by typing the email associated with this account
          </label>
          <input
